...
!(function (e, t) {
  ...
  n(() => {
    new l(document.body).holdTransition(),
      setTimeout(() => {
  ...
  const a = ".lte.push-menu",
    ...
    y = { sidebarBreakpoint: 992 };
  class g {
    constructor(e, t) {
      (this._element = e),
        (this._config = Object.assign(Object.assign({}, y), t));
    }
    menusClose() {
    ...
    addSidebarBreakPoint() {
      ...
      const s =
          null !==
            (t =
              null === (e = document.querySelector(u)) || void 0 === e
                ? void 0
                : e.classList) && void 0 !== t
            ? t
            : [],
        i =
          null !== (n = Array.from(s).find((e) => e.startsWith(h))) &&
          void 0 !== n
            ? n
            : "",
      ...
      (this._config = Object.assign(Object.assign({}, this._config), {
        ...
        window.innerWidth <= this._config.sidebarBreakpoint
          ? this.collapse()
          : (document.body.classList.contains(d) || this.expand(),
            document.body.classList.contains(d) &&
  ...
  n(() => {
    ...
    (n.className = "sidebar-overlay"),
      null === (e = document.querySelector(".app-wrapper")) ||
        void 0 === e ||
        e.append(n),
      ...
      document.querySelectorAll(v).forEach((e) => {
        e.addEventListener("click", (e) => {
          ...
          "sidebar" !== (null == t ? void 0 : t.dataset.lteToggle) &&
            (t = null == t ? void 0 : t.closest(v)),
            t && (null == e || e.preventDefault(), new g(t, y).toggle());
        });
      });
  });
  const f = ".lte.treeview",
    ...
    w = ".nav-item",
    L = ".nav-treeview",
    S = { animationSpeed: 300, accordion: !0 };
  class x {
    constructor(e, t) {
      (this._element = e),
        (this._config = Object.assign(Object.assign({}, S), t));
    }
    open() {
      var e, t;
      const n = new Event(_);
      if (this._config.accordion) {
        const t =
          null === (e = this._element.parentElement) || void 0 === e
            ? void 0
            : e.querySelectorAll(`${w}.${b}`);
        null == t ||
          t.forEach((e) => {
  ...
  n(() => {
    document.querySelectorAll('[data-lte-toggle="treeview"]').forEach((e) => {
      e.addEventListener("click", (e) => {
        ...
        ("#" !== (null == t ? void 0 : t.getAttribute("href")) &&
          "#" !== (null == s ? void 0 : s.getAttribute("href"))) ||
          e.preventDefault(),
          n && new x(n, S).toggle();
      });
    });
  ...
  class U {
    constructor(e, t) {
      (this._element = e),
        (this._parent = e.closest(J)),
        e.classList.contains(O) && (this._parent = e),
        (this._config = Object.assign(Object.assign({}, R), t));
    }
    collapse() {
      var e, t;
      const n = new Event(A);
      this._parent &&
        (this._parent.classList.add(M),
        (null === (e = this._parent) || void 0 === e
          ? void 0
          : e.querySelectorAll(`${K}, ${Q}`)
        ).forEach((e) => {
          e instanceof HTMLElement && s(e, this._config.animationSpeed);
        }),
        setTimeout(() => {
          this._parent &&
            (this._parent.classList.add(C), this._parent.classList.remove(M));
        }, this._config.animationSpeed)),
        null === (t = this._element) || void 0 === t || t.dispatchEvent(n);
    }
    expand() {
      var e, t;
      const n = new Event(D);
      this._parent &&
        (this._parent.classList.add(H),
        (null === (e = this._parent) || void 0 === e
          ? void 0
          : e.querySelectorAll(`${K}, ${Q}`)
        ).forEach((e) => {
        ...
        setTimeout(() => {
          this._parent &&
            (this._parent.classList.remove(C),
            this._parent.classList.remove(H));
        }, this._config.animationSpeed)),
        null === (t = this._element) || void 0 === t || t.dispatchEvent(n);
    }
    remove() {
      var e;
      const t = new Event(B);
      this._parent && s(this._parent, this._config.animationSpeed),
        null === (e = this._element) || void 0 === e || e.dispatchEvent(t);
    }
    toggle() {
      var e;
      (
    ...
    maximize() {
      ...
      this._parent &&
        ...
        setTimeout(() => {
          ...
          e && e.classList.add(N),
            this._parent &&
              (this._parent.classList.add(N),
              this._parent.classList.contains(C) &&
                this._parent.classList.add(W));
        }, 150)),
        null === (e = this._element) || void 0 === e || e.dispatchEvent(t);
    }
    minimize() {
      ...
      this._parent &&
        ...
        setTimeout(() => {
          ...
          t && t.classList.remove(N),
            this._parent &&
              (this._parent.classList.remove(N),
              (null === (e = this._parent) || void 0 === e
                ? void 0
                : e.classList.contains(W)) && this._parent.classList.remove(W));
        }, 10)),
        null === (e = this._element) || void 0 === e || e.dispatchEvent(t);
    }
    toggleMaximize() {
