 <nav class="app-header navbar sticky-top navbar-expand bg-body" data-bs-theme="light"> <!--begin::Container-->
 		...
 		<ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
 			...
 			<li class="nav-item dropdown user-menu">
 				<a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
 					<img src="../../files/uploads/avatars/<?= htmlspecialchars($userProfile['avatar']); ?>" class="user-image rounded-circle shadow" alt="User Image">
 					<span class="d-none d-md-inline"><?= $userProfile['name']; ?></span>
 				</a>
 				<ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
 					<li class="user-header text-bg-primary">
 						<img src="../../files/uploads/avatars/<?= htmlspecialchars($userProfile['avatar']); ?>" class="rounded-circle shadow" alt="User Image">
 						<p>
