...
<main class="app-main" style="background: transparent;"> <!--begin::App Content Header-->
    <header class="app-content-header"> <!--begin::Container-->
    ...
    </header> <!--end::App Content Header--> <!--begin::App Content-->
