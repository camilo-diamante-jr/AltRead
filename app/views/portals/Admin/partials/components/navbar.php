          ...
          <ul class="navbar-nav ms-auto">
              ...
              <li class="dropdown">
                  <a type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                      <img src="../../files/uploads/avatars/<?= htmlspecialchars($userProfile['avatar']); ?>" class="user-image rounded-circle shadow" alt="User Image" width="32" height="32">
                      <span
                          class="d-none d-md-inline fw-bold capitalize"><?= htmlspecialchars($userProfile['name']); ?></span>
                  </a>
